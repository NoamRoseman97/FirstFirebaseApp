...
public class MessageAdapter extends RecyclerView.Adapter<MessageViewHolder> {
    ...
    public MessageAdapter(String user_ID) {
        ...
        db.collection("NoamChat").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
    ...
    public void onBindViewHolder(@NonNull MessageViewHolder holder, int position) {
        ...
        if (message.userID.equals(user_ID)) {
    ...
    public void addMessage(chatMessage m) {
            ...
            FirebaseFirestore db = FirebaseFirestore.getInstance();
            db.collection("NoamChat").document(String.valueOf(System.currentTimeMillis()))
                    .set(message);
        }
    }
